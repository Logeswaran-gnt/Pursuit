Pursuit is an application developed usign Django Framework, this will be used as an alternative to to-do slips.
...
<b>Technology Stack: Python3.6, Django1.11, Bootstrap, Postress, Docker-Container<b><br>
